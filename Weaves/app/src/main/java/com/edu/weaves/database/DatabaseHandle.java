package com.edu.weaves.database;
...
public class DatabaseHandle extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "weavesUsers";
    // Users table name
    ...
    public void addUser(Users users) {
        ...
        values.put(KEY_SCORE, users.getScore()); // User score
    ...
    public Users getUser(int id) {
        ...
        Cursor cursor = db.query(TABLE_USERS, new String[]{KEY_ID,
                        KEY_NAME, KEY_AGE, KEY_SCORE}, KEY_ID + "=?",
    ...
    public List<Users> getAllUsers() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                users.setAge(cursor.getDouble(2));
                users.setScore(cursor.getDouble(3));
                // Adding User to list
                usersList.add(users);
